...
config.hpp
-----------------
The blockchain parameters can be modified in the `libraries/chain/include/graphene/chain/config.hpp <https://github.com/graphene-blockchain/graphene-core/blob/release/libraries/chain/include/graphene/chain/config.hpp>`_ file:
