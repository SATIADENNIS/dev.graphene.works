...
*Graphene Core - graphene::chain*

This document purpose: to bring Graphene Protocols information (files) close to users.
...
The below information are a collection of the Graphene Protocols. Sometimes it's difficult to find and read through all of them.  The original files locate: (..\\libraries\\chain\\include\\graphene\\chain\\protocol\\xxx.hpp)
...
---------------------
  ...
  - `config.hpp <https://github.com/graphene-blockchain/graphene-core/blob/release/libraries/chain/include/graphene/chain/config.hpp>`_
