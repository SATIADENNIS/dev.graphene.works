...
- A simple Python script, ``saltpass.py`` is avaliable `[click here] <https://github.com/graphene-blockchain/graphene-core/blob/master/programs/witness_node/saltpass.py>`_ to obtain hash and salt values from a password.
