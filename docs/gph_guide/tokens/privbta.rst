...
Alternatively to regular MPA like the bitUSD, Graphene also offers entrepreneurs an opportunity to create their own SmartCoins with custom parameters and a distinct set of *price feed* producers.
