...
**INFORMATOPN**
:: `Graphene Core Coding Style Guide (DRAFT)  <https://github.com/graphene-blockchain/graphene-core/wiki/Style-Guide>`_
...
* `How an Exchange can integrate their services to the Graphene UI Wallet - Gateway Integration Requirements <https://github.com/graphene-blockchain/graphene-ui/wiki/Gateway-Integration-Requirements>`_ : from Graphene UI wiki
* :ref:`How can I enable RPC Logging? <rpc-logging>`
* :ref:`How to script Websockets by Python <websocket-script-support>`

Assets
===========
* Read: User Guide `Graphene Assets Tokens <https://docs.gph.ai/en/latest/gph_holders/tokens.html>`_
...
* `What is a  prediction market? <https://docs.gph.ai/en/latest/gph_holders/tokens/pm.html>`_
...
Graphene Decentralized Exchange (DEX)
=========================================

* Read: `User Guide : Dex <https://docs.gph.ai/en/latest/gph_holders/dex.html>`_
...
* :ref:`How can I prepare Graphene Exchange? (Single Node Edition) <exchange-single-node>`
...
* :ref:`How can I use Graphene APIs? <bis-explorer-api-tryitout>`

  - Try Graphene Explorer APIs!

* `How can I install Graphene Explorer REST API? - Installation Guide <https://github.com/oxarbitrage/bitshares-explorer-api#bitshares-explorer-rest-api>`_
...
============================
* Read" User Guide `(DPOS) <https://docs.gph.ai/en/latest/technology/dpos.html#>`_
...
* `How to configure a witness_node as a delayed_node <https://github.com/graphene-blockchain/graphene-core/wiki/Delayed-Node>`_
...
* :ref:`How to run a Graphene API Node <run-api-node-guide>`
...
* `Graphene Block Production Monitor <https://github.com/roelandp/Bitshares-Witness-Monitor>`_


Performance
===========================
* `How to run the Performance Test <https://github.com/graphene-blockchain/graphene-core/tree/develop/tests/performance>`_

Plugin
===================

* Type of `Graphene Plugins:  Github ReadMe <https://github.com/graphene-blockchain/graphene-core/tree/master/libraries/plugins/README.md>`_
...
* `Plugin Template - (create a demo API hello) <https://github.com/graphene-blockchain/graphene-core/blob/hello_plugin/libraries/plugins/hello/README.md>`_
* `Discussion: "Create plugin script" (#1302) <https://github.com/graphene-blockchain/graphene-core/pull/1302>`_
...
* :ref:`How to use the CLI wallet to Perform Stealth Transfers in Graphene (wiki) <w-stealth-transfers>`
...
* `Where to find Graphene Public Full Nodes <https://github.com/graphene-blockchain/graphene-ui/blob/staging/app/api/apiConfig.js>`_
