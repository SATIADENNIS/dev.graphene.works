...
.. Attention:: The ``delayed_node`` program is no longer supported after Graphene Core 4.0.0 is released. For the instruction, *How to configure a witness_node as a delayed_node*, check the following link:
