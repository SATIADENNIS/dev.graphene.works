...
We now know what the installed bitshares-core folder contains and how inside folders and files have been structured. In this section, we test running two programs (witness_node and cli_wallet) to examine and get familiar with the Graphene Blockchain data and application program.

Also, we will launch a cli_wallet and import an existing Graphene account and check the balance. Let's start.
...
.. tip::
  ...
  - If you have already a Graphene account, you can look up the account balance information. For example,
