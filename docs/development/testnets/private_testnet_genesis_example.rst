...
.. tip:: If you want to generate new keys pairs, you can use
   - ``suggest_brain_key``  in cli_wallet. Or  ``./get_dev_key``  in the ``programs/genesis_util/`` by using the corresponding network prefix("GPH", "TEST", "MY", etc).
...
- "max_core_supply" refers to **TEST** in testnet, and to **GPH** in mainnet.
