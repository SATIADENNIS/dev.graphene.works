...
**************************************
Set up Graphene Private Testnet
**************************************


This chapter provides for instructions for preparing Graphene Private Testnet.
...
.. list-table::
   ...
   * - **$HOME/bitshares-testnet**
     - uses for downloading Graphene Core files and build the programs
   * - **$HOME/Testnet-Home**
     - uses for your Graphene Private Testnet Project


* Example files location for this section: developers.gph.ai/docs/development/testnets/

  - `prv_Get-Dev-Key-used-in-my-genesis.txt (get_dev_key) <https://github.com/graphene-blockchain/dev.graphene.works/blob/master/docs/development/testnets/prv_Get-Dev-Key-used-in-my-genesis.txt>`_
  - `prv_my-genesis-example-Private-testnet.json (my-genesis.json) <https://github.com/graphene-blockchain/dev.graphene.works/blob/master/docs/development/testnets/prv_my-genesis-example-Private-testnet.json>`_
  - `prv_config-ini-example.txt  (config.ini) <https://github.com/graphene-blockchain/dev.graphene.works/blob/master/docs/development/testnets/prv_config-ini-example.txt>`_
...
Downloading Graphene Core (testnet branch) and Build
========================================================

This section includes instructions for the following:

* Downloading Graphene Core
* Building two application program files (witness_node and cli_wallet)

|

1.Downloading Graphene Core – Testnet branch – source files
-------------------------------------------------------------------

  A. Open a command window and move to ``$HOME`` directory

  B. Run the following commands to connect Github Graphene Care repository, create a directory ``bitshares-testnet`` for the source code. Move the directory to the ``bitshares-testnet`` folder, and checkout a ``testnet`` branch.
...
Creating Another Directory for the Graphene Private Testnet Project
==========================================================================

This section includes instructions for the following:

* Creating another directory for Graphene Private Testnet Project
* Copying two application files into the Graphene Private Testnet Project directory
...
1.Creating another directory for Graphene Private Testnet Project
-------------------------------------------------------------------
...
- Read more about the `Committees roles in docs.gph.ai <https://docs.gph.ai/en/latest/gph_holders/community_members.html#committees>`_
