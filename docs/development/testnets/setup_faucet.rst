...
If you are interested Python-based faucet, check out `Tapin <https://github.com/bitshares/tapin>`_ . Tapin is a python-based faucet for Graphene-based blockchains (e.g. Graphene).
